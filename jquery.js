/*涓嶈兘鍘嬬缉锛屽帇缂╁氨浼氭姤閿�/*! jQuery v3.3.1 | (c) JS Foundation and other contributors | jquery.org/license */ ! function(e, t) { "use strict"; "object" == typeof module && "object" == typeof module.exports ? module.exports = e.document ? t(e, !0) : function(e) { if (!e.document) throw new Error("jQuery requires a window with a document"); return t(e) } : t(e) }("undefined" != typeof window ? window : this, function(e, t) {
    "use strict";
    var n = [],
        r = e.document,
...
function set_cookie(t, e, o, n) {
    ...
    for (a in t) document.cookie = a + "=" + t[a] + i + "; domain=" + (o || "200ui.com") + "; path=" + (n || "/")
}
...
function isAndroid() {
    ...
    if (userAgent.indexOf('Android') > -1 || userAgent.indexOf('Adr') > -1) { //android缂佸牏顏�
        return true;
    }
...
function isIOS() {
    var userAgent = navigator.userAgent;
    if (!!userAgent.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/)) { //ios缂佸牏顏�
        return true;
    }
...
function imgError(flag, e) {
    let src = "https://ae01.alicdn.com/kf/HTB10e7DRirpK1RjSZFhq6xSdXXa2.jpg";
    switch (flag) {
        case 1:
            src = "https://ae01.alicdn.com/kf/HTB1j03BRb2pK1RjSZFsq6yNlXXaS.jpg";
        break;
        case 2:
            src = "https://ae01.alicdn.com/kf/HTB15G.HRkvoK1RjSZFNq6AxMVXa9.jpg";
        break;
    }
    e.src = src;
    //鎺у埗涓嶈涓€鐩磋烦鍔�
